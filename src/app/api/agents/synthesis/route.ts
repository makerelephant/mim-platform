...
export async function GET() {
  ...
  try {
    ...
    // ── 1. Gather feed cards and CEO actions ──
    ...
    const synthesisResponse = await anthropic.messages.create({
      ...
      max_tokens: 4000,
      system: `You are the MiM Brain synthesis engine. You analyze weekly activity data for Made in Motion, a youth sports technology company, and identify patterns, correlations, and actionable insights.
...
- "description": a clear, actionable natural language description
...
- If there is insufficient data for meaningful insights, return fewer items rather than low-quality ones
